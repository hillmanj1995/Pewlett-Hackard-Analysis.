...
-- Left joining current_emp and dept_emp tables
...
-- Inner join the employees, salaries, and dept_emp tables into the emp_info
SELECT e.emp_no,
    e.first_name,
	e.last_name,
    e.gender,
...
-- List of current sales employees
SELECT ce.emp_no,
	ce.first_name,
	ce.last_name,
	d.dept_name
...
-- List of current sales & development employees
SELECT ce.emp_no,
	ce.first_name,
	ce.last_name,
	d.dept_name
